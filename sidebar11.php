                ...
                <div data-container="navigation">
                    <div class="j-nav-variant-standard">
                        <ul id="mainNav1" class="mainNav1">
                            ...
                            <li><a href="?page=main8" class="level_1"><span>Гостевая книга</span></a></li>
                            <ul id="mainNav2" class="mainNav1"> <!-- Changed the ID to mainNav2 -->
                                <li><a href="?page=main9" class="level_2"><span>Тесты</span></a></li>
